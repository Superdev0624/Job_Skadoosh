            ...
            <div class=" prviews formnew">
                <div class="row">
                    ...
                    <div class="col-lg-6 float-right">
                        <a href="{{ url('client/post-a-job/'.$code) }}" class="mkch">Make Changes</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="container">
                <div class="prvbtns text-center">
                    <a href="{{ url('client/post-a-job') }}" class="mkch default">Back to Job Detail</a>
                    @if( $jobData->is_premium == true)
                        <a href="{{ url('client/make-payment/'.$code) }}" class="mkch">
                            {{ CustomHelper::gotoPaymentstatus() }}
                        </a>
                        @else
                        <a href="{{ url('client/freepost') }}" class="mkch">
