...
<html lang="en">
	<head>
		...
		<!--[if lte IE 9]>
			<link rel="stylesheet" href="{{ asset('admin_assets/css/ace-part2.min.css') }}" />
		<![endif]-->
				...
				<div class="row">
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							...
							<div class="center">
								<h1>
									<span class="blue" id="id-text2">Login</span>
								</h1>
							</div>
...
<![endif]-->
		...
		<script type="text/javascript" src="{{ asset('admin_assets/js/auth.login.js') }}"></script>
	</body>
</html>