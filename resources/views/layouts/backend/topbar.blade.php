        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ URL::asset('/admin_assets/images/logo.svg') }}" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                ...
                <a href="index" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="{{ URL::asset('/admin_assets/images/logo-light.svg') }}" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ URL::asset('/admin_assets/images/logo-light.png') }}" alt="" height="19">
                    </span>
                </a>
            </div>
