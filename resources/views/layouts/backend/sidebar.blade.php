        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="#" key="t-tui-calendar">@lang('translation.TUI_Calendar')</a></li>
                        ...
                        <li>
                            <a href="javascript: void(0);">
                                <span class="badge rounded-pill badge-soft-success float-end"
                                    key="t-new">@lang('translation.New')</span>
                                <span key="t-#">@lang('translation.Templates')</span>
                            </a>
                            <ul class="sub-menu" aria-expanded="true">
                                <li><a href="#"
            ...
            -->
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        ...
                        <span key="t-projects">Categories</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ url('admin/category') }}" key="t-p-list">Categories List</a></li>
                        <li><a href="{{ url('admin/category/create') }}" key="t-create-new">Add New</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ url('admin/job') }}" key="t-task-list">Jobs List</a></li>
                        <li><a href="{{ url('admin/job/create') }}" key="t-create-task">Add New</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="#" key="t-offcanvas">@lang('translation.Offcanvas')</a></li>
                        ...
                        <li><a href="#" key="t-placeholders">@lang('translation.Placeholders')</a></li>
                        ...
                        <li><a href="#" key="t-toasts">@lang('translation.Toasts')</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="#" key="t-form-validation">@lang('translation.Form_Validation')</a>
                        </li>
