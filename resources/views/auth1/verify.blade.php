                            ...
                            <div class="bg-primary bg-soft">
                                <div class="row">
                                    ...
                                    <div class="col-5 align-self-end">
                                        <img src="{{ URL::asset('/admin_assets/images/profile-img.png') }}" alt="" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <a href="index">
                                        <div class="avatar-md profile-user-wid mb-4">
                                            <span class="avatar-title rounded-circle bg-light">
                                                <img src="{{ URL::asset('/admin_assets/images/logo.svg') }}" alt="" class="rounded-circle" height="34">
                                            </span>
                                        </div>
                                    </a>
                                </div>
